...
data.gru <- read.csv("E:/Documentos/Mestrado/Projeto/dados_gr.csv", sep = ";")
if (small_areas){
  data_raw <- read.csv("C:/Users/RosanaTeixeira/Downloads/census_data/AllThemesTablesSA.csv")  
  ireland_map <- readShapePoly('C:/Users/RosanaTeixeira/Downloads/boundary_files/Census2011_Small_Areas_generalised20m.shp')
  ...
  data_raw <- read.csv("C:/Users/RosanaTeixeira/Downloads/census_data/AllThemesTablesED.csv")  
  names(data_raw)[1] <- "GEOGID" 
  ireland_map <- readShapePoly('C:/Users/RosanaTeixeira/Downloads/boundary_files/Census2011_Electoral_Divisions_generalised20m.shp')
